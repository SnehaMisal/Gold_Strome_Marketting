...
@Component({
  selector: 'app-downline-referral',
  templateUrl: './downline-referral.component.html',
  styleUrls: ['./downline-referral.component.scss']
})
export class DownlineReferralComponent implements OnInit {
