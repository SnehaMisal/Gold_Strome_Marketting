...
@Component({
  selector: 'app-user-l2-referrals',
  templateUrl: './user-l2-referrals.component.html',
  styleUrls: ['./user-l2-referrals.component.scss']
})
export class UserL2ReferralsComponent implements OnInit {
