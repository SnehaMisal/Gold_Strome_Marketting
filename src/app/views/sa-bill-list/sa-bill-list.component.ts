...
@Component({
  selector: 'app-sa-bill-list',
  templateUrl: './sa-bill-list.component.html',
  styleUrls: ['./sa-bill-list.component.scss']
})
export class SaBillListComponent implements OnInit {
  approvalstatus: any;
